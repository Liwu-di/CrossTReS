...
class AbstractEnv(gym.Env):
    ...
    PERCEPTION_DISTANCE = 100.0 * MDPVehicle.SPEED_MAX
    ...
    def reset(self) -> Observation:
        ...
        return self.observation_type.observe(self.obsfornn_all)
    ...
    def step(self, action: Action) -> Tuple[Observation, float, bool, dict]:
        ...
        obs = self.observation_type.observe(self.obsfornn_all)
