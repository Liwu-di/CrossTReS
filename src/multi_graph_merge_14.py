...
args.mask_feature = 0
if args.mask_feature == 0:
    virtual_prox_adj = np.zeros(virtual_prox_adj.shape)
if args.mask_feature == 1:
    virtual_road_adj = np.zeros(virtual_road_adj.shape)
if args.mask_feature == 2:
    virtual_poi_adj = np.zeros(virtual_poi_adj.shape)
if args.mask_feature == 3:
    virtual_s_adj = np.zeros(virtual_s_adj.shape)
if args.mask_feature == 4:
    virtual_d_adj = np.zeros(virtual_d_adj.shape)
else:
    log("none")
