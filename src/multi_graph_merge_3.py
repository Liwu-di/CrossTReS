...
for ep in range(num_epochs):
    ...
    log(ny_time_dc.reshape((1, -1))[th_mask_source.bool()].shape)
    log(chi_time_dc.reshape((1, -1))[th_mask_source.bool()].shape)
    source_weights_ma = source_weights_ma * ny_time_dc.reshape((1, -1))[th_mask_source.bool()]
    source_weights_ma2 = source_weights_ma2 * chi_time_dc.reshape((1, -1))[th_mask_source2.bool()]
