...
for ep in range(num_epochs):
    ...
    source_weights_ma = source_weights_ma * ny_time_dc[th_mask_source.bool()].reshape(-1)
    source_weights_ma2 = source_weights_ma2 * chi_time_dc[th_mask_source2.bool()].reshape(-1)
